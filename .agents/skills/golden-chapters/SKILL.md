...
6. 运行门禁：执行 `node scripts/check-golden-structure.js settings/scout_report.yaml content/chapter_001.md`
7. 如不通过，调整后重新生成
...
5. **单章锻造检查**：
   ...
   - 章尾钩子是否让读者想看第三章
   - 与第一章是否有情绪差异（不能趋同）
6. 运行门禁：执行 `node scripts/check-golden-structure.js settings/scout_report.yaml content/chapter_001.md content/chapter_002.md`
...
6. 运行门禁：执行 `node scripts/check-golden-structure.js settings/scout_report.yaml content/chapter_001.md content/chapter_002.md content/chapter_003.md`
7. **停顿确认**：本章验证通过后，与用户确认，直至被 Accept。
...
2. 运行门禁：执行 `node scripts/check-ai-patterns.js content/chapter_001.md content/chapter_002.md content/chapter_003.md`
3. 运行门禁：执行 `node scripts/check-degeneration.js content/chapter_001.md content/chapter_002.md content/chapter_003.md`
4. 根据检测结果修改正文
5. 重新运行脚本直到通过
