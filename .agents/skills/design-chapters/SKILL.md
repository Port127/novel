...
4. **门禁校验**：
   ...
   - 运行 `scripts/check-outlines.js settings/chapter_outlines/`
...
- **`check-chapters.js`**：检查每章节拍数（3-15）、字数（2000-5000）、必填字段（words_target/density/beats）完整性，以及对应的 Markdown 文件是否存在。
