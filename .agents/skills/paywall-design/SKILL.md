...
- **脚本一**：`node .agents/skills/paywall-design/scripts/check-paywall.js settings/chapters_index.yaml paywall_report.yaml` 验证报告字段完整、最终切点一致、免费末章/付费首章边界、切点章张力值，以及前方是否有过长平淡期。
