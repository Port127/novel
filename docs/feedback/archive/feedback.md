...
# 小说skill
你先阅读.agents/skills/design-character（skill、references、scripts），注意：每个字符都要看！
...
很好，你分析很到位，现在参考.agents/skills/SKILL_TEMPLATE.md，进行最后的收敛

最后在审查一次.agents/skills/design-character（skill、references、scripts），从多角度、全局考虑，有任何问题都可以提出来
