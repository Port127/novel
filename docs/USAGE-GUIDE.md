...
- [四、写作阶段（心流状态，别打断我）](#四写作阶段心流状态别打断我)
  - [快捕设定 / 补角色 / AI 初稿 / 卡文求助 / 灵感分拣 / 场景建档](#1-突然想到一个新设定)
...
- [七、修改已有内容](#七修改已有内容)
  - [改项目信息 / 改设定 / 改大纲 / 改角色 / 推进状态](#1-改项目信息书名类型视角)
...
会从六个维度给出评分：**套话密度、句式重复、比喻过载、描写堆砌、对白同质化、机械转折**。每个维度独立打分，定位到具体段落。
