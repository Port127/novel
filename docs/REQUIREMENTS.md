...
| `worldbuilding` | 世界观设计 | 品类已选择 | `settings/worldbuilding.yaml` |
| `design-character` | 人设设计（含爽感评估） | 品类已选择 | `settings/characters.yaml` |
| `design-outline` | 大纲设计（含节奏分析） | 品类+世界观 | `settings/outline.yaml` + `settings/arcs.yaml` |
| `design-chapters` | 细纲设计（章节拆分） | 大纲已完成 | `settings/chapters_index.yaml` |
